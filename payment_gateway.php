...
<body>
    <div class="container">
        <form id="paymentForm" action="process_payment_2.php" method="post">
            ...
            <div class="form-content active" id="step1">
                ...
                <div class="button-container">
                    <button class="button" id="cancelButton" type="button"><i class="fas fa-chevron-left"></i> Back</button>
            ...
            <div class="form-content" id="step2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="zip" name="zip" required minlength="10" maxlength="10">
                </div>
                <div class="button-container">
            ...
            <div class="form-content" id="step3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="card_number" name="card_number" placeholder="xxx xxxx xxxx xxxx" required minlength="19" maxlength="19">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="cvv" name="cvv" placeholder="123" required minlength="3" maxlength="4">
                </div>
                <div class="button-container">
